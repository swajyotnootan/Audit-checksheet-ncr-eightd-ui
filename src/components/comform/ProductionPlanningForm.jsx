...
const canDeleteJob = () => {
  ...
  const handleSaveAll = async () => {
    try {
      ...
      if (!inspectionId) {
        ...
        await axios.put(`https://internalaudit.hub.swajyot.co.in:8090/api/public/json-data/${inspectionId}`, payload);
  ...
  const handleDeleteJob = async () => {
    ...
    try {
      ...
      await axios.delete(`https://internalaudit.hub.swajyot.co.in:8090/api/public/json-data/${inspectionId}`);
    ...
    try {
      ...
      if (inspectionId) {
        try {
          ...
          const response = await axios.get(`https://internalaudit.hub.swajyot.co.in:8090/api/public/json-data/${inspectionId}`);
          if (response.data.success) {
            const existingData = JSON.parse(response.data.data.jsonContent);
            ...
            await axios.put(`https://internalaudit.hub.swajyot.co.in:8090/api/public/json-data/${inspectionId}`, {
