...
/api/printing-inspection/status`, {
        params: { status }
      });
      return response.data;
    } catch (error) {
...
/api/printing-inspection/${id}`, reportData);
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  submitReport: async (id, userName) => {
    try {
      const response = await apiClient.put(`https://internalaudit.hub.swajyot.co.in:8090
/api/printing-inspection/submit/${id}`);
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  approveReport: async (id, userName, comments = '') => {
    try {
      const response = await apiClient.put(`https://internalaudit.hub.swajyot.co.in:8090
/api/printing-inspection/approve/${id}`, null, {
        params: { comments }
      });
      return response.data;
    } catch (error) {
  ...
  rejectReport: async (id, userName, comments) => {
    try {
      const response = await apiClient.put(`https://internalaudit.hub.swajyot.co.in:8090
/api/printing-inspection/reject/${id}`, null, {
        params: { comments }
      });
      return response.data;
    } catch (error) {
  ...
  deleteReport: async (id) => {
    try {
      await apiClient.delete(`https://internalaudit.hub.swajyot.co.in:8090
/api/printing-inspection/${id}`);
  ...
  downloadPdf: async (id, userName) => {
    try {
      const response = await apiClient.get(`https://internalaudit.hub.swajyot.co.in:8090
/api/printing-inspection/pdf/${id}`, {
        responseType: 'blob',
        headers: { 'Accept': 'application/pdf' }
      });
...
export const lineClearanceAPI = {
  ...
  getFormsBySubmitter: async (submitter) => {
    try {
      const response = await apiClient.get(`https://internalaudit.hub.swajyot.co.in:8090
/api/line-clearance/submitter/${submitter}`);
      return response.data;
    } catch (error) {
      throw error;
    }
...
/api/line-clearance/${id}/submit`, null, {
        params: { submittedBy },
      });
      return response.data;
    } catch (error) {
  ...
  approveForm: async (id, reviewedBy, comments = '') => {
    try {
      const response = await apiClient.post(`https://internalaudit.hub.swajyot.co.in:8090
/api/line-clearance/${id}/approve`, null, {
        params: { reviewedBy, comments },
      });
      return response.data;
    } catch (error) {
  ...
  rejectForm: async (id, reviewedBy, comments) => {
    try {
      const response = await apiClient.post(`https://internalaudit.hub.swajyot.co.in:8090
/api/line-clearance/${id}/reject`, null, {
        params: { reviewedBy, comments },
      });
      return response.data;
    } catch (error) {
  ...
  downloadPdf: async (id, username) => {
    try {
      const response = await apiClient.get(`https://internalaudit.hub.swajyot.co.in:8090
/api/line-clearance/${id}/pdf/${username}`, {
        responseType: 'blob',
        headers: { 'Accept': 'application/pdf' },
      });
  ...
  sendEmailWithPdf: async (id, emailData) => {
    try {
      const response = await apiClient.post(`https://internalaudit.hub.swajyot.co.in:8090
/api/line-clearance/${id}/email-pdf`, emailData);
      return response.data;
    } catch (error) {
      console.error('Error sending email:', error);
      throw error;
...
export const auditAPI = {
  ...
  downloadPdfWithSignatures: async (id, signatureData) => {
    try {
      const response = await apiClient.post(`https://internalaudit.hub.swajyot.co.in:8090
/api/audits/${id}/pdf-with-signatures`, signatureData, {
        responseType: 'blob',
        headers: { Accept: 'application/pdf' },
      });
...
/api/notifications/user/${userId}/read-all`);
  ...
  clearAll: async (userId) => {
    try {
      const response = await apiClient.delete(`https://internalaudit.hub.swajyot.co.in:8090
/api/notifications/user/${userId}`);
      return response.data;
    } catch (error) {
