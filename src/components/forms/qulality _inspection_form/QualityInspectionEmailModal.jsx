        ...
        <div className={loading ? 'opacity-50 pointer-events-none' : ''}>
          <div className="mb-4">
            ...
            <input
              ...
              required
              disabled={loading}
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-800 focus:border-blue-800 disabled:bg-gray-100 disabled:cursor-not-allowed"
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              rows={4}
              disabled={loading}
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-800 focus:border-blue-800 disabled:bg-gray-100 disabled:cursor-not-allowed resize-none"
            />
          </div>
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button
              ...
              disabled={loading}
              className="px-4 py-2 bg-blue-800 text-white rounded-md hover:bg-background focus:outline-none focus:ring-2 focus:ring-blue-300 disabled:bg-blue-300 disabled:cursor-not-allowed flex items-center transition-colors min-w-24 justify-center"
            >
              {loading ? (
                <>
