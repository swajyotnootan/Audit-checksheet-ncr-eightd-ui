  ...
  useEffect(() => {
    const fetchRecord = async () => {
      ...
      try {
        ...
        const res = await axios.get(`https://internalaudit.hub.swajyot.co.in:8090/api/eightd/data/${eventId}`);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (recordId) {
        ...
        await axios.put(`https://internalaudit.hub.swajyot.co.in:8090/api/eightd/data/${eventNo}`, formData, {
