...
{!shouldHideCalendar() && (
  <button
    ...
    className="relative p-1.5 rounded-lg hover:bg-white/80 hover:text-black transition-all duration-200"
    title="Calendar"
  >
    <Calendar className="w-6 h-6 text-white/80 hover:text-black transition-colors" />
  </button>
)}
